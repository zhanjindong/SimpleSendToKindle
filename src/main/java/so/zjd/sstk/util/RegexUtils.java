...
public class RegexUtils {
	 ...
	 * @return true 或 false
	 */
	public static boolean match(String regex, String input, boolean caseInsensitive) {
	 ...
	 * @return 匹配到的子串列表
	 */
	public static List<String> findAll(String regex, String input, boolean caseInsensitive) {
	 ...
	 * @return 分割后的数组
	 */
	public static String[] split(String regex, String input, boolean caseInsensitive) {
		if (StringUtils.isEmpty(regex) || StringUtils.isEmpty(input))
			throw new IllegalArgumentException("regex and value can not be null or empty!");
	 ...
	 * @return 替换后的字符串
	 */
	public static String replaceAll(String regex, String input, String replacement, boolean caseInsensitive) {
		if (StringUtils.isEmpty(regex) || StringUtils.isEmpty(input) || replacement == null)
			throw new IllegalArgumentException("regex,source and replace can not be empty or null!");
